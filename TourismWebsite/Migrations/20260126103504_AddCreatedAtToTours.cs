...
{
    /// <inheritdoc />
    public partial class AddCreatedAtToTours : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TouristName = table.Column<string>(type: "TEXT", nullable: false),
                    TouristEmail = table.Column<string>(type: "TEXT", nullable: false),
                    TouristPhone = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TouristBookings", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK_TouristBookings_Tours_TourId",
                        column: x => x.TourId,
                        principalTable: "Tours",
                        principalColumn: "TourId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TouristBookings_TourId",
                table: "TouristBookings",
                column: "TourId");
        }
